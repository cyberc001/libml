...
typedef double (*loss_func)(vec y, vec _y, void* args); // y - accurate value, _y - predicted value
typedef double (*loss_d_func)(vec y, vec _y, size_t i, void* args); // i - vector component index to take derivative in regard to
...
double squared_loss(vec y, vec _y, void* args);
...
double neg_log_likelihood_ns_loss(vec y, vec _y, void* args);

/* Common loss functions' partial derivatives */
double d_squared_loss(vec y, vec _y, size_t i, void* args);
double d_neg_log_likelihood_ns_loss(vec y, vec _y, size_t i, void* args);
